    ...
    <aside
        ...
        <div class="w-full h-full flex flex-col">
            ...
            <div class="items-start flex flex-col">
                <a href="{{ route('mahasiswa.kelola-sidang') }}" wire:navigate wire:current="bg-primary-shadow/50" class="hover:bg-primary-shadow transition duration-100 border-dark border-t-2 border-b-2 p-4 w-full flex flex-row gap-2">
                    <div>
                ...
                <a href="{{ route('mahasiswa.tugas-akhir') }}" wire:navigate wire:current="bg-primary-shadow/50" class="hover:bg-primary-shadow transition duration-100 border-dark border-b-2 p-4 w-full flex flex-row gap-2">
                    <div>
            ...
            <div class="flex flex-col mt-auto p-4">
                <p class="text-2xl">
                    SiapTA, <span class="font-bold">Mahasiswa</span>
                </p>
            </div>            
        </div>
    </aside>
